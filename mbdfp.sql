...
(1,1,'C++ Learning',NULL,1,10,0.00,2),
(2,5,'Database - mysql',NULL,3,60,300.00,20);
...
(2,'External Storage',510.00,NULL,1,1500);
...
/*!50003 CREATE FUNCTION `fn_isjobavailable`(`f_usrid` INT, `f_jid` INT) RETURNS tinyint(1)
BEGIN
...
/*!50003 CREATE FUNCTION `fn_isuserfree`(`f_id` INT) RETURNS tinyint(1)
BEGIN
...
/*!50003 CREATE FUNCTION `fn_jobtime`(f_uid int, f_jid int) RETURNS int(11)
BEGIN
...
/*!50003 CREATE FUNCTION `fn_stamina`(`f_id` INT) RETURNS int(11)
BEGIN
...
/*!50003 CREATE FUNCTION `fn_upgradecost`(f_upid int, f_uid int) RETURNS int(11)
BEGIN
...
/*!50003 CREATE PROCEDURE `sp_changepassword`(`p_uname` VARCHAR(50), `p_oldpass` VARCHAR(50), `p_newpass` VARCHAR(50))
proc:BEGIN
...
/*!50003 CREATE PROCEDURE `sp_levelupdate`(`p_usrid` INT, `p_dx` INT)
BEGIN
...
/*!50003 CREATE PROCEDURE `sp_login`(`p_uname` VARCHAR(50), `p_password` VARCHAR(50))
BEGIN
...
/*!50003 CREATE PROCEDURE `sp_register`(`p_uname` VARCHAR(15), `p_password` VARCHAR(32), `p_name` VARCHAR(20))
BEGIN
...
/*!50003 CREATE PROCEDURE `sp_takecourse`(`p_usrid` INT, `p_courseid` INT)
BEGIN
...
/*!50003 CREATE PROCEDURE `sp_takecoursereward`(`p_usrid` INT, `p_cid` INT)
BEGIN
...
/*!50003 CREATE PROCEDURE `sp_takejob`(`p_usrid` INT, `p_jid` INT)
BEGIN
	call sp_updatestamina(p_usrid);
...
/*!50003 CREATE PROCEDURE `sp_takejobreward`(`p_usrid` INT, `p_jid` INT)
BEGIN
...
/*!50003 CREATE PROCEDURE `sp_updatestamina`(`p_usrid` INT)
BEGIN
...
/*!50003 CREATE PROCEDURE `sp_upgrade`(`p_usrid` INT, `p_upgrid` INT)
BEGIN
